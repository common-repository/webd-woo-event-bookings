...
if($webd_shop_view!=''){
	$clss .= ' webd-default-'.$webd_shop_view;
}
...
<div class="container">
	...
	?>
		...
		if(is_search() && webd_global_search_result_page()=='map'){
			echo do_shortcode('[webd_map]');
		}else if((!isset($_GET['view'])&& !is_search() && is_shop() && $webd_shop_view!='list') || (isset($_GET['view']) && sanitize_text_field($_GET['view'])!='list' && !is_search() && is_shop())){
