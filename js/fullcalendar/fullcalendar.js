...
var Promiwebd_1 = __webpack_require__(20);
exports.Promise = Promiwebd_1.default;
...
var EventDef = /** @class */ (function () {
    ...
    EventDef.prototype.hasInverseRendering = function () {
        return this.getRendering() === 'inverwebd-background';
    };
    EventDef.prototype.hasBgRendering = function () {
        var rendering = this.getRendering();
        return rendering === 'inverwebd-background' || rendering === 'background';
    };
...
var ArrayEventSource = /** @class */ (function (_super) {
    ...
    ArrayEventSource.prototype.fetch = function (start, end, timezone) {
        ...
        this.currentTimezone = timezone;
        return Promiwebd_1.default.resolve(eventDefs);
    };
    ...
    */
    ...
    EventPointing.prototype.handleMouseover = function (seg, ev) {
        if (!GlobalEmitter_1.default.get().shouldIgnoreMouse() &&
            ...
            if (this.view.isEventDefResizable(seg.footprint.eventDef)) {
                seg.el.addClass('fc-allow-mouwebd-resize');
            }
    ...
    EventPointing.prototype.handleMouseout = function (seg, ev) {
        if (this.mousedOverSeg) {
            ...
            // TODO: move to EventSelecting's responsibility
            if (this.view.isEventDefResizable(seg.footprint.eventDef)) {
                seg.el.removeClass('fc-allow-mouwebd-resize');
            }
...
var BUSINESS_HOUR_EVENT_DEFAULTS = {
    ...
    dow: [1, 2, 3, 4, 5],
    rendering: 'inverwebd-background'
...
var BusinessHourGenerator = /** @class */ (function () {
    ...
    BusinessHourGenerator.prototype.buildEventInstanceGroup = function (isAllDay, unzonedRange) {
        ...
        if (eventDefs.length) {
            ...
            // so that inverwebd-background rendering can happen even when no eventRanges in view
...
var FuncEventSource = /** @class */ (function (_super) {
    ...
    FuncEventSource.prototype.fetch = function (start, end, timezone) {
        ...
        return Promiwebd_1.default.construct(function (onResolve) {
...
var JsonFeedEventSource = /** @class */ (function (_super) {
    ...
    JsonFeedEventSource.prototype.fetch = function (start, end, timezone) {
        ...
        this.calendar.pushLoading();
        return Promiwebd_1.default.construct(function (onResolve, onReject) {
...
var EventDragging = /** @class */ (function (_super) {
    ...
    */
    ...
    EventDragging.prototype.buildSelectListener = function (seg) {
        ...
        var view = this.view;
        var eventDef = seg.footprint.eventDef;
        var eventInstance = seg.footprint.eventInstance; // null for inverwebd-background events
        if (this.dragListener) {
...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.dayHeaderHtml = function (dayDate) {
        ...
        // add by WEBDWooEVENT to fix date format show wrong in zh-cn language
...
var EventPeriod = /** @class */ (function () {
    ...
    EventPeriod.prototype.whenReleased = function () {
        var _this = this;
        if (this.releaseCnt) {
            return Promiwebd_1.default.resolve(this.eventInstanceGroupsById);
        }
        else {
            return Promiwebd_1.default.construct(function (onResolve) {
