...
function exc_mb_sample_metaboxes( array $meta_boxes ) {
	...
	$fields = array(
		...
		array( 'id' => 'field-16', 'name' => 'Post select field', 'type' => 'post_select', 'uwebd_ajax' => false, 'query' => array( 'cat' => 1 ) ),
		array( 'id' => 'field-17', 'name' => 'Post select field (AJAX)', 'type' => 'post_select', 'uwebd_ajax' => true ),
		array( 'id' => 'field-17b', 'name' => 'Post select field (AJAX)', 'type' => 'post_select', 'uwebd_ajax' => true, 'query' => array( 'posts_per_page' => 8 ), 'multiple' => true  ),
